...
namespace OdyPatch.UI.Update
{
    ...
    /// Mirrors the structure produced by odypatch/config.py.
    /// </summary>
    public sealed class RemoteUpdateInfo
    {
        [JsonPropertyName("odypatchLatestVersion")]
        public string LatestVersion { get; set; } = string.Empty;

        [JsonPropertyName("odypatchLatestNotes")]
        public string LatestReleaseNotes { get; set; } = string.Empty;

        [JsonPropertyName("odypatchDownloadLink")]
        public string ReleaseDownloadPage { get; set; } = string.Empty;

        [JsonPropertyName("odypatchDirectLinks")]
        ...
        [JsonPropertyName("odypatchLatestBetaVersion")]
        public string LatestBetaVersion { get; set; } = string.Empty;

        [JsonPropertyName("odypatchLatestBetaNotes")]
        public string LatestBetaNotes { get; set; } = string.Empty;

        [JsonPropertyName("odypatchBetaDownloadLink")]
        public string BetaDownloadPage { get; set; } = string.Empty;

        [JsonPropertyName("odypatchBetaDirectLinks")]
