...
using OdyPatch.UI;
using OdyPatch.UI.Update;
using RteDocument = global::OdyPatch.UI.Rte.RteDocument;
using RemoteUpdateInfo = global::OdyPatch.UI.Update.RemoteUpdateInfo;
using OdyPatch.UI.Views;
using OdyPatch.UI.Views.Dialogs;
...
namespace OdyPatch.UI.ViewModels
{
    ...
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        /// <summary>
        /// Window title matching Python's format: "OdyPatch {VERSION_LABEL}"
        ...
        public string WindowTitle
        {
            get
            {
                string title = $"OdyPatch {Core.VersionLabel}";
                if (IsAlphaVersion)
                {
        ...
        public MainWindowViewModel()
        {
            ...
            AddLogEntry("Welcome to OdyPatch!", LogType.Note);
        ...
        private async Task CheckUpdates()
        {
            try
            {
                ...
                Dictionary<string, object> updateInfo = await Config.GetRemoteOdyPatchUpdateInfoAsync(useBetaChannel);
                ...
                if (Config.RemoteVersionNewer(Config.CurrentVersion, latestVersion))
                {
                    ...
                    string message = $"A newer version of OdyPatch ({latestVersion}) is available.{Environment.NewLine}{Environment.NewLine}{notes}";
                ...
                {
                    string message = $"You are already running the latest version of OdyPatch ({Core.VersionLabel}).";
        ...
        /// This is a legacy structure - use OdyPatch.Rte.RteDocument instead.
        /// </summary>
