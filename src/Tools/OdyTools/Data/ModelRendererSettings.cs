...
namespace OdyTools.Data
{
    ...
    {
        // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/widgets/settings/preview_3d.py:15-16
        // Original: def __init__(self): super().__init__("ModelRenderer")
        public ModelRendererSettings() : base("ModelRenderer")
        {
        }

        // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/widgets/settings/preview_3d.py:19-22
        ...
        // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/widgets/settings/preview_3d.py:26-29
