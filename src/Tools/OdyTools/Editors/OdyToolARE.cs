...
{
    // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/editors/are.py:35
    ...
    public class OdyToolARE : Editor
    {
        ...
        // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/editors/are.py:36-74
        ...
        private void SetupUI()
        {
            ...
            // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/editors/are.py:111-117
            ...
            if (_installation != null)
            {
                try
                {
                    TwoDA cameras = _installation.HtGetCache2DA(OdyInstallation.TwoDACameras);
                    if (cameras != null)
                    {
        ...
        // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/editors/are.py:134-149
        ...
        public override void Load(string filepath, string resref, ResourceType restype, byte[] data)
        {
            ...
            _originalGff = gff;
            // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/editors/are.py:146
            // Original: are: ARE = read_are(data)
            _are = AREHelpers.ConstructAre(gff);
            LoadARE(_are);
        }

        // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/editors/are.py:151-248
        ...
        // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/editors/are.py:250-300
        // Original: def build(self) -> tuple[bytes, bytes]:
        public override Tuple<byte[], byte[]> Build()
        {
            // Matching Python: are = deepcopy(self._are) / _buildARE() which creates new ARE and sets from UI
            // Following OdyToolUTW pattern: create copy then read from UI controls
            ...
            // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/editors/are.py:326-348
            // Terrain section
            ...
            // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/editors/are.py:313-322
            ...
            // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/editors/are.py:250-277
            // Original: def build(self) -> tuple[bytes, bytes]:
        ...
        // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/editors/are.py:302-310
        ...
        // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/editors/are.py:386-391
        ...
        // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/editors/are.py:392-393
        ...
        // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/editors/are.py:408-411
        ...
        // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/editors/are.py:76-104
        ...
        // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/editors/are.py:106-132
        ...
        private void SetupInstallation(OdyInstallation installation)
        {
            ...
            // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/editors/are.py:129-132
