...
{
    public partial class OdyToolTwoDA : Editor
    {
        ...
        /// </summary>
        public OdyToolTwoDA() : this(null, null) { }

        public OdyToolTwoDA(Window parent = null, OdyInstallation installation = null)
        ...
        private void OnWindowKeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (ctrl)
            {
                ...
                else if (e.Key == Key.E) { _formulaBarEdit?.Focus(); e.Handled = true; }
        ...
        private void UpdateStatusBar()
        {
            try
            {
                ...
                if (_statusText != null)
                {
                    ...
                    if (selRow != null && colIdx >= 0)
                    {
                        ...
                        if (rowIdx >= 0)
                        {
                            ...
                            baseText += $" | Cell: R{rowIdx}, {colName}";
                        }
                    }
                ...
                if (_sidebarStatsText != null)
                {
                    int rows = _sourceData?.Count ?? 0;
                    int cols = 1 + (_columnHeaders?.Count ?? 0);
                    string stats = $"{rows} rows × {cols} columns";
                    if (_filteredData?.View?.Filter != null)
                    {
                        int visible = _filteredData.View.Cast<object>().Count();
                        stats = $"{visible} of {rows} rows";
                    }
        ...
        public void InsertMultipleRows()
        {
            ...
            var label = new TextBlock { Text = "How many rows to insert?" };
            ...
            var ok = new Button { Content = "OK", Margin = new Avalonia.Thickness(0, 0, 8, 0) };
        ...
        private void ShowFindDialog()
        {
            ...
            var matchCase = new CheckBox { Content = "Match case", IsChecked = _findMatchCase };
            var buttons = new StackPanel { Orientation = Orientation.Horizontal, Margin = new Avalonia.Thickness(0, 8, 0, 0) };
            var findNext = new Button { Content = "Find Next", Margin = new Avalonia.Thickness(0, 0, 8, 0) };
        ...
        private void ShowReplaceDialog()
        {
            ...
            var replaceBtn = new Button { Content = "Replace", Margin = new Avalonia.Thickness(0, 0, 8, 0) };
        ...
        private void ShowGoToRowDialog()
        {
            ...
            var panel = new StackPanel { Margin = new Avalonia.Thickness(12) };
            var label = new TextBlock { Text = "Row index (0-based):" };
        ...
        public async Task RenameColumnAsync()
        {
            ...
            var panel = new StackPanel { Margin = new Avalonia.Thickness(12) };
            var label = new TextBlock { Text = "Column name:" };
            var textBox = new TextBox { Text = currentName };
            var buttons = new StackPanel { Orientation = Orientation.Horizontal, Margin = new Avalonia.Thickness(0, 8, 0, 0) };
            var ok = new Button { Content = "OK", Margin = new Avalonia.Thickness(0, 8, 0, 0) };
            var cancel = new Button { Content = "Cancel" };
            panel.Children.Add(label);
            panel.Children.Add(textBox);
            buttons.Children.Add(ok);
        ...
        public async Task AddColumnAsync()
        {
            ...
            var panel = new StackPanel { Margin = new Avalonia.Thickness(12) };
            var label = new TextBlock { Text = "Column name:" };
            var textBox = new TextBox { Watermark = "NewColumn" };
            var buttons = new StackPanel { Orientation = Orientation.Horizontal, Margin = new Avalonia.Thickness(0, 8, 0, 0) };
            var ok = new Button { Content = "OK", Margin = new Avalonia.Thickness(0, 0, 8, 0) };
            var cancel = new Button { Content = "Cancel" };
            panel.Children.Add(label);
            ...
            {
                string name = textBox.Text?.Trim() ?? "";
                if (string.IsNullOrEmpty(name)) name = "NewColumn";
