...
{
    // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/editors/mdl.py:25
    ...
    public class OdyToolMDL : Editor
    {
        ...
        // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/editors/mdl.py:26-42
        ...
        // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/editors/mdl.py:44-45
        ...
        // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/editors/mdl.py:47-99
        ...
        public override void Load(string filepath, string resref, ResourceType restype, byte[] data)
        {
            ...
            {
                // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/editors/mdl.py:95
            ...
            if (_modelRenderer != null)
            {
                // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/editors/mdl.py:98
            ...
            // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/editors/mdl.py:99
            // Original: self._mdl = read_mdl(mdl_data, 0, 0, mdx_data, 0, 0)
            _mdl = MDLAuto.ReadMdl(mdlData, 0, null, mdxData, 0, 0);
        }

        // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/editors/mdl.py:101-108
        ...
        // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/editors/mdl.py:110-114
        ...
        // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/editors/mdl.py:116-119
