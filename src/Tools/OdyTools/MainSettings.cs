...
namespace OdyTools.NET
{
    ...
    public static class MainSettings
    {
        ...
        /// <summary>
        /// Applies the theme from GlobalSettings to the Avalonia Application.
        /// Supports Light, Dark, and Default (system) variants.
        /// </summary>
        public static void ApplyTheme()
        {
            ...
            string theme = settings.SelectedTheme ?? "Light";
            theme = theme.Trim();
            ...
            {
                // Light or any unrecognized value defaults to Light
