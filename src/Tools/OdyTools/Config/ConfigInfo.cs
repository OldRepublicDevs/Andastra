        ...
        public static Dictionary<string, object> LocalProgramInfo => new Dictionary<string, object>
        {
            ...
            ["toolsetDirectLinks"] = new Dictionary<string, Dictionary<string, List<string>>>
            {
                ["Darwin"] = new Dictionary<string, List<string>>
                {
                    ...
                    {
                        "https://github.com/th3w1zard1/PyKotor/releases/download/v{tag}-toolset/OdyTools_Mac_PyQt5_x64.zip"
                    }
                },
                ["Linux"] = new Dictionary<string, List<string>>
                {
                    ...
                    ["64bit"] = new List<string>
                    {
                        "https://github.com/th3w1zard1/PyKotor/releases/download/v{tag}-toolset/OdyTools_Linux_PyQt5_x64.zip"
                    }
                },
                ["Windows"] = new Dictionary<string, List<string>>
                {
                    ["32bit"] = new List<string>
                    {
                        "https://github.com/th3w1zard1/PyKotor/releases/download/v{tag}-toolset/OdyTools_Windows_PyQt5_x86.zip"
                    },
                    ["64bit"] = new List<string>
                    {
                        "https://github.com/th3w1zard1/PyKotor/releases/download/v{tag}-toolset/OdyTools_Windows_PyQt5_x64.zip"
                    }
                }
            },
