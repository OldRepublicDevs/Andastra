...
namespace OdyTools.Dialogs
{
    public partial class CloneModuleDialog : Window
    {
        ...
        public CloneModuleDialog(
            Window parent,
            OdyInstallation active,
            Dictionary<string, OdyInstallation> installations)
        {
            InitializeComponent();
            _active = active;
        ...
        public class ModuleOption
        {
            ...
            public ModuleOption(string name, string root, List<string> files, OdyInstallation installation)
            {
                Name = name;
                Root = root;
