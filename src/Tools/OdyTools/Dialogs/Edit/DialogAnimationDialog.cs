...
namespace OdyTools.Dialogs.Edit
{
    ...
    public partial class DialogAnimationDialog : Window
    {
        ...
        private void LoadAnimationData()
        {
            ...
            // Matching PyKotor: anim_list: TwoDA | None = installation.ht_get_cache_2da(OdyInstallation.TwoDA_DIALOG_ANIMS)
            TwoDA animList = _installation.HtGetCache2DA(OdyInstallation.TwoDADialogAnims);
            if (animList == null)
            {
                System.Console.WriteLine($"LoadAnimationData: {OdyInstallation.TwoDADialogAnims} not found, the Animation List will not function!!");
            ...
            // Matching PyKotor: self.ui.animationSelect.set_context(anim_list, installation, OdyInstallation.TwoDA_DIALOG_ANIMS)
            _animationSelect.SetContext(animList, _installation, OdyInstallation.TwoDADialogAnims);
