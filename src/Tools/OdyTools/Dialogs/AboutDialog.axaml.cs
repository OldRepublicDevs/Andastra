...
namespace OdyTools.Dialogs
{
    ...
    public partial class AboutDialog : Window
    {
        ...
        private void LoadIconImage()
        {
            ...
            {
                "avares://OdyTools.NET/Resources/Icons/sith.png",
                "avares://OdyTools/Resources/Icons/sith.png",
            ...
            try
            {
                ...
                var resourceName = "OdyTools.NET.Resources.Icons.sith.png";
                ...
                resourceName = "OdyTools.Resources.Icons.sith.png";
                using (var stream = assembly.GetManifestResourceStream(resourceName))
                {
                    if (stream != null)
                    {
