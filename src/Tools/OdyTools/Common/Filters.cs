...
{
    // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/common/filters.py:17
    ...
    // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/common/filters.py:23
    ...
    public class RobustSortFilterProxyModel : TemplateFilterProxyModel
    {
        ...
        // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/common/filters.py:32
        ...
        // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/common/filters.py:47
        ...
        // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/common/filters.py:52
    ...
    // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/common/filters.py:75
    ...
    public class NoScrollEventFilter
    {
        ...
        // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/common/filters.py:76
        ...
        // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/common/filters.py:96
    ...
    // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/common/filters.py:123
    // Original: class HoverEventFilter(QObject):
    public class HoverEventFilter
    {
        // Matching PyKotor implementation at Tools/OdyTools/src/toolset/gui/common/filters.py:132
        // Original: def eventFilter(self, obj: QObject, event: QEvent) -> bool:
