...
namespace OdyTools.Widgets.Settings
{
    ...
    public partial class MiscSettingsWidget : UserControl
    {
        ...
        private void SetupProgrammaticUI()
        {
            ...
            _useBetaChannel = new CheckBox { Content = "Use Beta Channel", Name = "useBetaChannel" };
            _attemptKeepOldGFFFields = new CheckBox { Content = "Attempt Keep Old GFF Fields", Name = "attemptKeepOldGFFFields" };
            _saveRimCheck = new CheckBox { Content = "Save RIM", Name = "saveRimCheck" };
            _mergeRimCheck = new CheckBox { Content = "Merge RIM", Name = "mergeRimCheck" };
            _greyRimCheck = new CheckBox { Content = "Grey RIM", Name = "greyRimCheck" };
            _showPreviewUTCCheck = new CheckBox { Content = "Show Preview UTC", Name = "showPreviewUTCCheck" };
            _showPreviewUTPCheck = new CheckBox { Content = "Show Preview UTP", Name = "showPreviewUTPCheck" };
            _showPreviewUTDCheck = new CheckBox { Content = "Show Preview UTD", Name = "showPreviewUTDCheck" };

            _moduleSortOptionComboBox = new ComboBox { Name = "moduleSortOptionComboBox" };
            _moduleSortOptionComboBox.Items.Add("Name");
            _moduleSortOptionComboBox.Items.Add("Date");

            _tempDirEdit = new TextBox { Watermark = "Extract Path", Name = "tempDirEdit" };
            _gffEditorCombo = new ComboBox { Name = "gffEditorCombo" };
            _gffEditorCombo.Items.Add("Standard");
            _gffEditorCombo.Items.Add("Specialized");
            _ncsToolEdit = new TextBox { Watermark = "NCS Decompiler Path", Name = "ncsToolEdit" };
            _nssCompEdit = new TextBox { Watermark = "NSS Compiler Path", Name = "nssCompEdit" };
