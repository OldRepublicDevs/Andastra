...
namespace HoloPatcher.UI.Views
{
    public partial class RteEditorWindow : Window
    {
        ...
        public RteEditorWindow(string initialDirectory = null)
        {
            ...
            // Control fields are auto-generated by Avalonia from XAML x:Name attributes
            var fontSizeComboBox = this.FindControl<ComboBox>("FontSizeComboBox");
            var foregroundComboBox = this.FindControl<ComboBox>("ForegroundComboBox");
            var backgroundComboBox = this.FindControl<ComboBox>("BackgroundComboBox");
            var editor = this.FindControl<RichTextBox>("Editor");
