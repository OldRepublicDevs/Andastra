...
namespace KotorDiff.Diff
{
    ...
    public class StructuredDiffEngine
    {
            ...
            string rightId)
        {
            try
            {
                var leftReader = new BioWare.Resource.Formats.TwoDA.TwoDABinaryReader(leftData);
                var rightReader = new BioWare.Resource.Formats.TwoDA.TwoDABinaryReader(rightData);
            ...
            string rightId)
        {
            try
            {
                var leftReader = new BioWare.Resource.Formats.GFF.GFFBinaryReader(leftData);
                var rightReader = new BioWare.Resource.Formats.GFF.GFFBinaryReader(rightData);
