...
{
    /// <summary>
    /// Infinity engine delay scheduler implementation.
    /// </summary>
    /// <remarks>
    /// Infinity Delay Scheduler:
    /// - Based on MassEffect.exe and MassEffect2.exe delay systems
    ...
    /// 
    /// Note: Infinity engine delay system is similar to Odyssey, using float-based time.
    /// Engine-specific differences may exist in integration with other systems.
    /// </remarks>
    public class InfinityDelayScheduler : BaseDelayScheduler
    {
        private float _currentTime;

        /// <summary>
        /// Initializes a new instance of the InfinityDelayScheduler.
        /// </summary>
        public InfinityDelayScheduler()
        {
            _currentTime = 0;
        }
        ...
        {
            // Based on MassEffect.exe and MassEffect2.exe: Delay scheduler implementation
