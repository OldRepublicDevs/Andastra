...
namespace Andastra.Runtime.Core.Video.Bink
{
    ...
    /// Based on k1_win_gog_swkotor.exe: 0x00404c80 @ 0x00404c80 (main playback loop)
    /// </summary>
    internal class BikDecoder : IDisposable
    {
        ...
        public void Open()
        {
            ...
            // Based on k1_win_gog_swkotor.exe: 0x004053e0 @ 0x004053e0 line 154-160
        ...
        /// Based on k1_win_gog_swkotor.exe: 0x00404c80 @ 0x00404c80 line 13 checks frame count
        /// </summary>
        ...
        /// Based on k1_win_gog_swkotor.exe: 0x00404c80 @ 0x00404c80 line 29-33 (BinkWait with Sleep loop)
        /// </summary>
        public void WaitForFrame()
        {
            ...
            // Based on k1_win_gog_swkotor.exe: 0x00404c80 @ 0x00404c80 line 29-33
