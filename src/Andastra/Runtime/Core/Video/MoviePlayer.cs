...
namespace Andastra.Runtime.Core.Video
{
    ...
    /// <remarks>
    /// Movie Player System:
    /// - Based on k1_win_gog_swkotor.exe/k2_win_gog_aspyr_swkotor2.exe: CExoMoviePlayerInternal implementation
    ...
    public class MoviePlayer
    {
        ...
        public async Task<bool> PlayMovie(string movieResRef, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                // Based on k1_win_gog_swkotor.exe: Movie file loading (0x005fbbf0 @ 0x005fbbf0)
                ...
                // Based on k1_win_gog_swkotor.exe: 0x00404c80 @ 0x00404c80 (playback loop)
        ...
        private async Task<bool> PlayBikMovie(byte[] movieData, CancellationToken cancellationToken)
        {
            ...
            // Based on k1_win_gog_swkotor.exe: 0x004053e0 @ 0x004053e0 opens BIK file from path
            ...
            try
            {
                ...
                try
                {
                    ...
                    while (!decoder.IsComplete && !cancellationToken.IsCancellationRequested)
                    {
                        ...
                        // Based on k1_win_gog_swkotor.exe: 0x00404c80 @ 0x00404c80 line 35-40
        ...
        /// Based on k1_win_gog_swkotor.exe: 0x00404c80 @ 0x00404c80 line 27 (BinkBufferBlit)
        /// </summary>
