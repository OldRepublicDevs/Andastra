...
namespace Andastra.Runtime.Core.Interfaces
{
    ...
    ///   - k2_win_gog_aspyr_swkotor2.exe: 0x0041d2c0 @ 0x0041d2c0 (2DA table lookup), 0x0065a380 @ 0x0065a380 (GetCreatureRadius)
    ///   - k1_win_gog_swkotor.exe: Similar 2DA lookup system
    ...
    public interface IGameDataProvider
    {
        ...
        /// <remarks>
        /// Based on reverse engineering:
        /// - k2_win_gog_aspyr_swkotor2.exe: 0x0065a380 @ 0x0065a380 (GetCreatureRadius) calls 0x0041d2c0 to lookup "hitradius" from appearance.2da
        /// - k1_win_gog_swkotor.exe: Similar implementation
        ...
        /// <remarks>
        /// Based on reverse engineering:
        /// - k2_win_gog_aspyr_swkotor2.exe: 0x0041d2c0 @ 0x0041d2c0 (2DA table lookup)
        /// - k1_win_gog_swkotor.exe: Similar 2DA lookup system
        /// - nwmain.exe: C2DA::Load2DArray @ 0x1401a73a0 for 2DA loading
        /// - Generic table lookup method for accessing any game data table.
