...
namespace Andastra.Runtime.Core.Audio
{
    ...
    /// - Based on swkotor2.exe: FUN_00631ff0 @ 0x00631ff0 (writes VoiceVolume to INI file)
    /// - Based on swkotor2.exe: FUN_00633270 @ 0x00633270 (loads VoiceVolume from INI file)
    /// </remarks>
