...
namespace Andastra.Game.Games.Odyssey.Collision
{
    ...
    public class OdysseyCreatureCollisionDetector : BaseCreatureCollisionDetector
    {
        ...
        protected override CreatureBoundingBox GetCreatureBoundingBox(IEntity entity)
        {
            ...
            // [TODO: Function name] @ (K1: TODO: Find this address, TSL: TODO: Find this address address): 0x005479f0 @ 0x005479f0 gets width and height from entity structure
            ...
            // For collision detection, 0x005479f0 uses width at +0x14 and height at +0xbc
