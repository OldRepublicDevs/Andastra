...
{
    /// <summary>
    /// KOTOR 1 (k1_win_gog_swkotor.exe) specific player input handler.
    /// </summary>
    /// <remarks>
    /// K1 Player Input Handler:
    /// - Based on k1_win_gog_swkotor.exe input system further analysis
    ...
    /// - Reverse engineered functions (k1_win_gog_swkotor.exe):
    ///   - 0x0054b550 @ 0x0054b550 (k1_win_gog_swkotor.exe: input event handler for mouse clicks and movement)
    ...
    ///   - Note: 0x005226d0 in k2_win_gog_aspyr_swkotor2.exe is SerializeCreature_K2 (serialization), NOT input handling
    /// - Cross-engine comparison:
    ///   - K1 (k1_win_gog_swkotor.exe): Simpler input system without K2-specific features
    ///   - K2 (k2_win_gog_aspyr_swkotor2.exe): Enhanced input system with Influence, Prestige Classes, Combat Forms
    ...
    public class K1PlayerInputHandler : OdysseyPlayerInputHandler
    {
        ...
        /// <remarks>
        /// Based on k1_win_gog_swkotor.exe reverse engineering:
        /// - K1 has a simpler cursor system without combat form variations
        /// - 0x0054b550 @ 0x0054b550 (k1_win_gog_swkotor.exe) processes input events and determines cursor mode
        ...
        protected override CursorMode DetermineCursorMode(IEntity hoveredEntity)
        {
            ...
            // Based on k1_win_gog_swkotor.exe: Simpler cursor system than K2
        ...
        protected override float GetAttackRange()
        {
            ...
            // Based on k1_win_gog_swkotor.exe: INVENTORY_SLOT_RIGHTWEAPON = 4
            ...
            // Based on k1_win_gog_swkotor.exe weapon system
            ...
            if (itemComponent != null && World?.GameDataProvider != null)
            {
                ...
                if (baseItemId >= 0)
                {
                    ...
                    // Based on k1_win_gog_swkotor.exe: Reads maxattackrange column from baseitems.2da row indexed by BaseItem ID
                    ...
                    // Based on k1_win_gog_swkotor.exe: Ranged weapons have longer default range than melee
        ...
        protected override bool IsHostile(IEntity entity)
        {
            ...
            // Based on k1_win_gog_swkotor.exe: Simpler faction system than K2
