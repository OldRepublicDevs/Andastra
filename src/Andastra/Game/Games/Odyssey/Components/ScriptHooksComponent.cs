...
namespace Andastra.Game.Games.Odyssey.Components
{
    ...
    /// - Based on k1_win_gog_swkotor.exe and k2_win_gog_aspyr_swkotor2.exe script event system
    /// - Located via string references: "ScriptHeartbeat" @ 0x007beeb0 (k2_win_gog_aspyr_swkotor2.exe), "ScriptOnNotice" @ 0x007beea0
    ...
    ///   - k2_win_gog_aspyr_swkotor2.exe: 0x005226d0 @ 0x005226d0 (save script hooks for creatures)
    ///   - k2_win_gog_aspyr_swkotor2.exe: 0x00585ec0 @ 0x00585ec0 (save script hooks for placeables)
    ///   - k2_win_gog_aspyr_swkotor2.exe: 0x00584f40 @ 0x00584f40 (save script hooks for doors)
    ///   - k2_win_gog_aspyr_swkotor2.exe: 0x0050c510 @ 0x0050c510 (load script hooks from UTC template)
