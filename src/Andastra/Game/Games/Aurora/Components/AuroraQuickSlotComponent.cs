...
namespace Andastra.Game.Games.Aurora.Components
{
    ...
    /// - Quick bar storage: CNWSCreature::SaveQuickBar @ nwmain.exe (function address to be determined ), CNWSCreature::LoadQuickBar @ nwmain.exe (function address to be determined )
    ...
    /// - nwmain.exe: Aurora quick bar system with QBObjectType field (function addresses to be determined )
    /// - nwn2main.exe: Enhanced Aurora quick bar system with additional object types (function addresses to be determined )
