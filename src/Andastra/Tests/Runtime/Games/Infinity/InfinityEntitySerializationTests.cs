...
{
    /// <summary>
    /// Comprehensive tests for InfinityEntity serialization and deserialization.
    /// Tests all components, local variables, custom data, and edge cases.
    /// </summary>
    public class InfinityEntitySerializationTests
    {
        [Fact]
        public void Serialize_WithBasicProperties_ShouldSucceed()
        {
            // Arrange
            var entity = new InfinityEntity(123u, ObjectType.Creature, "test_creature");
            entity.AreaId = 456u;
        ...
        {
            // Arrange
            var originalEntity = new InfinityEntity(123u, ObjectType.Creature, "test_creature");
            originalEntity.AreaId = 456u;

            // Act
            byte[] serialized = originalEntity.Serialize();
            var deserializedEntity = new InfinityEntity(123u, ObjectType.Creature, "");
