...
- **Generic NCS CONST / 2DA-memory CONSTI disambiguation:** **control-flow arc landed** on [PR #36](https://github.com/th3w1zard1/Andastra/pull/36) (plans **324**–**341**, 2026-05-24) — jump-fork forward scan, guarded JZ/JNZ, local condition resolve, while-break continuation, forward-only JMP fork, subroutine/infinite-loop cutoff, KotorCLI cache-path gating (**337**–**338**), BioWare slow vs cache tests (**339**), README + KB docs (**340**–**341**); **88** NcsConsti + **18** FindStrRef + **12** CLI ref-search tests. OdyTools cache-path gating closed [PR #37](https://github.com/th3w1zard1/Andastra/pull/37) (plan **346**, 2026-06-03). **JSR call-literal StrRef consumer** closed [PR #46](https://github.com/th3w1zard1/Andastra/pull/46) (plan **356**, 2026-06-03). **JSR multi-arg slot alignment** closed [PR #48](https://github.com/th3w1zard1/Andastra/pull/48) (plan **358**, 2026-06-03). **Nested JSR relay StrRef** closed [PR #50](https://github.com/th3w1zard1/Andastra/pull/50) (plan **360**, 2026-06-03). **Nested JSR multi-arg relay StrRef** closed [PR #52](https://github.com/th3w1zard1/Andastra/pull/52) (plan **362**, 2026-06-03). **Two-hop multi-arg nested JSR relay** closed [PR #54](https://github.com/th3w1zard1/Andastra/pull/54) (plan **364**, 2026-06-03). **Mixed CONST+CPTOPSP nested JSR relay** closed [PR #56](https://github.com/th3w1zard1/Andastra/pull/56) (plan **366**, 2026-06-03). **Three-hop multi-arg nested JSR relay** closed [PR #58](https://github.com/th3w1zard1/Andastra/pull/58) (plan **368**, 2026-06-03). **Three-hop mixed CONST+CPTOPSP nested JSR relay** closed [PR #59](https://github.com/th3w1zard1/Andastra/pull/59) (plan **370**, 2026-06-03). **Two-hop mixed CONST+CPTOPSP nested JSR relay** closed [PR #61](https://github.com/th3w1zard1/Andastra/pull/61) (plan **372**, 2026-05-24). **Four-hop multi-arg nested JSR relay** closed [PR #63](https://github.com/th3w1zard1/Andastra/pull/63) (plan **374**, 2026-05-24); tracker sync plan **375** closed via plan **408** (2026-06-05); **98** NcsConsti + **18** FindStrRef + **12** CLI ref-search tests. **Build-ladder validation filters** documented: **Step 3b** StrRef/NCS CONSTI (plans **348**–**349**, [PR #38](https://github.com/th3w1zard1/Andastra/pull/38)); **Step 3c** ReferenceFinder/script ResRef (plans **350**–**351**, [PR #40](https://github.com/th3w1zard1/Andastra/pull/40)). Prior partial landing: `StrRefCandidateMinimum` (default 100), opcode-context v1 (**303**), action-signature slot matching (**305**), stack-store heuristics (**307**), variable/BP relay hops (**309**–**322**). **Still deferred:** full stack simulation for exotic control-flow and arithmetic relays beyond bounded hops.
...
- **OdyPatch `--validate` automated subprocess test:** **landed** — `tests/OdyPatch.Tests/` + CI `test` job (plan **297**, 2026-05-28). CI `nuget-pack-smoke` validate smoke (plan 055) remains complementary. PR **#12** merged plans **291**–**298** to `master` @ `9860ada2a` (2026-05-28); post-merge tracker sync plans **299**–**318** merged via PR **#13**–**#22**, PR **#23** @ `ced72418b` (plan **309** + tracker **310**, 2026-05-29), PR **#25** @ `08bd4a3a3` (plan **311** + tracker **312**, 2026-05-29), PR **#27** @ `76855e679` (plan **313** + tracker **314**, 2026-05-29), PR **#29** @ `58a2697fe` (plan **315** + tracker **316**, 2026-05-29), PR **#31** @ `326b812a1` (plan **317** + tracker **318**, 2026-05-29), PR **#34** @ `4514f2b05` (plans **321**–**322** + tracker **323**, 2026-05-30), PR **#33** @ `8bdf07844` (plan **319** + tracker **320**, 2026-05-30), and PR **#36** @ `f49c2a028` (plans **324**–**344** NCS CONSTI CF arc, 2026-06-03).
...
- **OdyTool LIP Holocron port (plans 376–377):** **landed** on [PR #65](https://github.com/th3w1zard1/Andastra/pull/65) (batch WAV processor, **5** LipBatchProcessor tests) and [PR #66](https://github.com/th3w1zard1/Andastra/pull/66) (keyframe editor UI, **2** OdyToolLIP tests, 2026-06-04). Audio preview (**378**), playback sync (**379**), and 3D head preview (**380**) in flight via PR **#67**–**#69**.
...
- NCS bytecode scanning **enabled** — StrRef CONSTI via `ReferenceCache` (plan **286**); script ResRef via `NcsConstStringScanner` (plan **287**). CONSTI disambiguation + control-flow arc **landed** on PR #36 (plans **292**–**341**): threshold, opcode-context, action-signature, relay hops, jump-fork CF scan, cache-path gating, slow vs cache docs; **90** NcsConsti tests. JSR call-literal StrRef consumer closed PR #46 (plan **356**). JSR multi-arg slot alignment closed PR #48 (plan **358**). Nested JSR relay StrRef closed PR #50 (plan **360**). Nested JSR multi-arg relay StrRef closed PR #52 (plan **362**). Two-hop multi-arg nested JSR relay closed PR #54 (plan **364**). Mixed CONST+CPTOPSP nested JSR relay closed PR #56 (plan **366**). Three-hop multi-arg nested JSR relay closed PR #58 (plan **368**). Three-hop mixed CONST+CPTOPSP nested JSR relay closed PR #59 (plan **370**). Two-hop mixed CONST+CPTOPSP nested JSR relay closed PR #61 (plan **372**). Four-hop multi-arg nested JSR relay closed PR #63 (plan **374**); **98** NcsConsti tests. Full stack simulation remains deferred.
