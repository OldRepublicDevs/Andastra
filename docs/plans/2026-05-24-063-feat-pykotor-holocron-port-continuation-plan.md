...
- **OdyPatch `--validate` automated subprocess test:** **landed** — `tests/OdyPatch.Tests/` + CI `test` job (plan **297**, 2026-05-28). CI `nuget-pack-smoke` validate smoke (plan 055) remains complementary.
