...
- **OdyPatch `--validate` automated subprocess test:** **landed** — `tests/OdyPatch.Tests/` + CI `test` job (plan **297**, 2026-05-28). CI `nuget-pack-smoke` validate smoke (plan 055) remains complementary. PR **#12** merged plans **291**–**298** to `master` @ `9860ada2a` (2026-05-28); post-merge tracker sync plans **299**–**306** merged via PR **#13** @ `360e48647`, PR **#14** @ `64a3308d2`, PR **#15** @ `8b3c6b244`, PR **#16** @ `75fc00744`, PR **#17** @ `0f7c5bf1e`, PR **#18** @ `b6b2d893a`, and PR **#19** @ `4e3ad2f6a` (plan **305** action-signature CONSTI + tracker **306**, 2026-05-28).
