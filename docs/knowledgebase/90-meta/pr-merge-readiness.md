...
| Scope | NCS CONSTI control-flow forward scan (plans **324**–**329**) + regression/cache/subroutine tests (**328**, **330**–**335**) + KotorCLI cache-path gating (**337**); **71** NcsConsti + **18** FindStrRef tests |
| Plans | **324**–**337** (feature **324**–**335**, **337**; tracker sync **325**, **336**) |
