...
## Suggested next slices (308+)

| Plan | Topic |
|------|-------|
| 309 | Variable StrRef CPTOPSP→ACTION forward trace (plan **063** CONSTI backlog) |
| 308+ | Module Designer depth, 2DA spreadsheet UX, OdyPatch E2E install runbook execution |
