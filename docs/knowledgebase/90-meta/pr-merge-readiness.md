...
## Suggested next slices (312+)

| Plan | Topic |
|------|-------|
| 312+ | Full CONSTI stack simulation for exotic control-flow per plan **063** |
| 312+ | Module Designer depth, 2DA spreadsheet UX, OdyPatch E2E install runbook execution |
