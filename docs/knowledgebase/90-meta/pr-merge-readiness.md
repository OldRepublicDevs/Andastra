...
| Ref-search Step 3b (NCS CONSTI / StrRef) | `--filter` NcsConsti (**98** on `master`; **161** pending **#131**), FindStrRefCommand (**18**), InstallationRefSearch CLI (**12**), StrRefReferenceHelper (**10**) | Green `[REPO]` (plans **348**–**461**, 2026-06-10) |
...
## NCS CONSTI stack simulation arc (open PR stack, plans 421–461)
...
**Merge order (recommended):** **#89** (docs, independent) → **#90** → **#91** → **#92** (docs, stacks on **#89**) → **#93** → **#94** → **#96** → **#98** → **#99** → **#101** → **#104** → **#106** → **#108** → **#110** → **#112** → **#114** → **#116** → **#119** → **#121** → **#123** → **#125** → **#127** → **#129** → **#131** (feature stack on **#91**/**#88** relay tip at **107** tests; rebase after relay merges). **#95**/**#97**/**#100**/**#102**/**#105**/**#107**/**#109**/**#111**/**#113**/**#115**/**#118**/**#120**/**#122**/**#124**/**#126**/**#128**/**#130** (docs v2–v18, stack on **#92**/**#95**/**#97**/**#100**/**#102**/**#105**/**#107**/**#109**/**#111**/**#113**/**#115**/**#118**/**#120**/**#122**/**#124**/**#126**/**#128**) can merge alongside doc slices. Plan **409**/**#77** arithmetic v1 is superseded by **#90** tip — close **#77** when **#90** lands. Local identity multihop relay characterization complete at **#131** (**161** tests). `[REPO]`
...
Merge **#103** to `master` early so stacked feature PRs (**#98**–**#131**) pick up green submit-nuget on rebase. `[REPO]`

## Suggested next slices (462+)

| Plan | Topic |
|------|-------|
| 417+ | Field-value arc merge stack **#81**–**#86** (open PR **#86**) |
| 462+ | Post-merge tracker sync after stack-simulation **#90**–**#131** lands |
| 462+ | Merge relay arc **#77**–**#88** then rebase stack-simulation tip |
| 462+ | Merge **#74** (CodeQL) early; KotorDiff installation ref search (**#71**) |
