...
| Ref-search Step 3b (NCS CONSTI / StrRef) | `--filter` NcsConsti (**98** on `master`; **149** pending **#119**), FindStrRefCommand (**18**), InstallationRefSearch CLI (**12**), StrRefReferenceHelper (**10**) | Green `[REPO]` (plans **348**–**449**, 2026-06-10) |
...
## NCS CONSTI stack simulation arc (open PR stack, plans 421–449)
...
**Merge order (recommended):** **#89** (docs, independent) → **#90** → **#91** → **#92** (docs, stacks on **#89**) → **#93** → **#94** → **#96** → **#98** → **#99** → **#101** → **#104** → **#106** → **#108** → **#110** → **#112** → **#114** → **#116** → **#119** (feature stack on **#91**/**#88** relay tip at **107** tests; rebase after relay merges). **#95**/**#97**/**#100**/**#102**/**#105**/**#107**/**#109**/**#111**/**#113**/**#115**/**#118** (docs v2–v12, stack on **#92**/**#95**/**#97**/**#100**/**#102**/**#105**/**#107**/**#109**/**#111**/**#113**/**#115**) can merge alongside doc slices. Plan **409**/**#77** arithmetic v1 is superseded by **#90** tip — close **#77** when **#90** lands. Local arithmetic multihop relay characterization complete at **#119** (**149** tests). `[REPO]`
...
Merge **#103** to `master` early so stacked feature PRs (**#98**–**#119**) pick up green submit-nuget on rebase. `[REPO]`

## Suggested next slices (450+)

| Plan | Topic |
|------|-------|
| 417+ | Field-value arc merge stack **#81**–**#86** (open PR **#86**) |
| 450+ | Post-merge tracker sync after stack-simulation **#90**–**#119** lands |
| 450+ | Merge relay arc **#77**–**#88** then rebase stack-simulation tip |
| 450+ | Merge **#74** (CodeQL) early; KotorDiff installation ref search (**#71**) |
