...
| Ref-search Step 3b (NCS CONSTI / StrRef) | `--filter` NcsConsti (**98** on `master`; **153** pending **#123**), FindStrRefCommand (**18**), InstallationRefSearch CLI (**12**), StrRefReferenceHelper (**10**) | Green `[REPO]` (plans **348**–**453**, 2026-06-10) |
...
## NCS CONSTI stack simulation arc (open PR stack, plans 421–453)
...
**Merge order (recommended):** **#89** (docs, independent) → **#90** → **#91** → **#92** (docs, stacks on **#89**) → **#93** → **#94** → **#96** → **#98** → **#99** → **#101** → **#104** → **#106** → **#108** → **#110** → **#112** → **#114** → **#116** → **#119** → **#121** → **#123** (feature stack on **#91**/**#88** relay tip at **107** tests; rebase after relay merges). **#95**/**#97**/**#100**/**#102**/**#105**/**#107**/**#109**/**#111**/**#113**/**#115**/**#118**/**#120**/**#122** (docs v2–v14, stack on **#92**/**#95**/**#97**/**#100**/**#102**/**#105**/**#107**/**#109**/**#111**/**#113**/**#115**/**#118**/**#120**) can merge alongside doc slices. Plan **409**/**#77** arithmetic v1 is superseded by **#90** tip — close **#77** when **#90** lands. Local arithmetic multihop relay characterization complete at **#123** (**153** tests). `[REPO]`
...
| 454+ | Post-merge tracker sync after stack-simulation **#90**–**#123** lands |
| 454+ | Merge relay arc **#77**–**#88** then rebase stack-simulation tip |
| 454+ | Merge **#74** (CodeQL) early; KotorDiff installation ref search (**#71**) |
