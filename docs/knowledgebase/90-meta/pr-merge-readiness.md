...
| Ref-search Step 3b (NCS CONSTI / StrRef) | `--filter` NcsConsti (**98** on `master`; **163** pending **#133**), FindStrRefCommand (**18**), InstallationRefSearch CLI (**12**), StrRefReferenceHelper (**10**) | Green `[REPO]` (plans **348**–**463**, 2026-06-10) |
...
## NCS CONSTI stack simulation arc (open PR stack, plans 421–463)
...
| [#107](https://github.com/th3w1zard1/Andastra/pull/107) | **438** | Stack simulation arc tracker sync v7 (docs) | Green `[REPO]` |
| [#108](https://github.com/th3w1zard1/Andastra/pull/108) | **439** | Triple multihop double arithmetic StrRef relay (**139** NcsConsti tests) | Green `[REPO]` |
| [#109](https://github.com/th3w1zard1/Andastra/pull/109) | **440** | Stack simulation arc tracker sync v8 (docs) | Green `[REPO]` |
| [#110](https://github.com/th3w1zard1/Andastra/pull/110) | **441** | Triple multihop combined arithmetic StrRef relay (**141** NcsConsti tests) | Green `[REPO]` |
| [#111](https://github.com/th3w1zard1/Andastra/pull/111) | **442** | Stack simulation arc tracker sync v9 (docs) | Green `[REPO]` |
| [#112](https://github.com/th3w1zard1/Andastra/pull/112) | **443** | Four-hop identity double arithmetic StrRef relay (**143** NcsConsti tests) | Green `[REPO]` |
...
| [#118](https://github.com/th3w1zard1/Andastra/pull/118) | **448** | Stack simulation arc tracker sync v12 (docs) | Green `[REPO]` |
| [#119](https://github.com/th3w1zard1/Andastra/pull/119) | **449** | Five-hop identity second-offset StrRef relay (**149** NcsConsti tests) | Green `[REPO]` |
| [#120](https://github.com/th3w1zard1/Andastra/pull/120) | **450** | Stack simulation arc tracker sync v13 (docs) | Green `[REPO]` |
| [#121](https://github.com/th3w1zard1/Andastra/pull/121) | **451** | Five-hop identity combined arithmetic StrRef relay (**151** NcsConsti tests) | Green `[REPO]` |
| [#122](https://github.com/th3w1zard1/Andastra/pull/122) | **452** | Stack simulation arc tracker sync v14 (docs) | Green `[REPO]` |
| [#123](https://github.com/th3w1zard1/Andastra/pull/123) | **453** | Five-hop identity double arithmetic StrRef relay (**153** NcsConsti tests) | Green `[REPO]` |
| [#124](https://github.com/th3w1zard1/Andastra/pull/124) | **454** | Stack simulation arc tracker sync v15 (docs) | Green `[REPO]` |
| [#125](https://github.com/th3w1zard1/Andastra/pull/125) | **455** | Six-hop identity double arithmetic StrRef relay (**155** NcsConsti tests) | Green `[REPO]` |
| [#126](https://github.com/th3w1zard1/Andastra/pull/126) | **456** | Stack simulation arc tracker sync v16 (docs) | Green `[REPO]` |
| [#127](https://github.com/th3w1zard1/Andastra/pull/127) | **457** | Six-hop identity second-offset StrRef relay (**157** NcsConsti tests) | Green `[REPO]` |
| [#128](https://github.com/th3w1zard1/Andastra/pull/128) | **458** | Stack simulation arc tracker sync v17 (docs) | Green `[REPO]` |
| [#129](https://github.com/th3w1zard1/Andastra/pull/129) | **459** | Six-hop identity combined arithmetic StrRef relay (**159** NcsConsti tests) | Green `[REPO]` |
| [#130](https://github.com/th3w1zard1/Andastra/pull/130) | **460** | Stack simulation arc tracker sync v18 (docs) | Green `[REPO]` |
| [#131](https://github.com/th3w1zard1/Andastra/pull/131) | **461** | Seven-hop identity double arithmetic StrRef relay (**161** NcsConsti tests) | Green `[REPO]` |
| [#132](https://github.com/th3w1zard1/Andastra/pull/132) | **462** | Stack simulation arc tracker sync v19 (docs) | Green `[REPO]` |
| [#133](https://github.com/th3w1zard1/Andastra/pull/133) | **463** | Seven-hop identity second-offset StrRef relay (**163** NcsConsti tests) | Green `[REPO]` |

**Merge order (recommended):** **#89** (docs, independent) → **#90** → **#91** → **#92** (docs, stacks on **#89**) → **#93** → **#94** → **#96** → **#98** → **#99** → **#101** → **#104** → **#106** → **#108** → **#110** → **#112** → **#114** → **#116** → **#119** → **#121** → **#123** → **#125** → **#127** → **#129** → **#131** → **#133** (feature stack on **#91**/**#88** relay tip at **107** tests; rebase after relay merges). **#95**/**#97**/**#100**/**#102**/**#105**/**#107**/**#109**/**#111**/**#113**/**#115**/**#118**/**#120**/**#122**/**#124**/**#126**/**#128**/**#130**/**#132** (docs v2–v19, stack on **#92**/**#95**/**#97**/**#100**/**#102**/**#105**/**#107**/**#109**/**#111**/**#113**/**#115**/**#118**/**#120**/**#122**/**#124**/**#126**/**#128**/**#130**) can merge alongside doc slices. Plan **409**/**#77** arithmetic v1 is superseded by **#90** tip — close **#77** when **#90** lands. Local identity multihop relay characterization complete at **#133** (**163** tests). `[REPO]`
...
Merge **#103** to `master` early so stacked feature PRs (**#98**–**#133**) pick up green submit-nuget on rebase. `[REPO]`

## Suggested next slices (464+)

| Plan | Topic |
|------|-------|
| 417+ | Field-value arc merge stack **#81**–**#86** (open PR **#86**) |
| 464+ | Post-merge tracker sync after stack-simulation **#90**–**#133** lands |
| 464+ | Merge relay arc **#77**–**#88** then rebase stack-simulation tip |
