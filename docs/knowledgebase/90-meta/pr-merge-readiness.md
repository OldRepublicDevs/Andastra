...
| Ref-search Step 3b (NCS CONSTI / StrRef) | `--filter` NcsConsti (**98** on `master`; **147** pending **#116**), FindStrRefCommand (**18**), InstallationRefSearch CLI (**12**), StrRefReferenceHelper (**10**) | Green `[REPO]` (plans **348**–**447**, 2026-06-10) |
...
## NCS CONSTI stack simulation arc (open PR stack, plans 421–447)
...
Merge **#103** to `master` early so stacked feature PRs (**#98**–**#116**) pick up green submit-nuget on rebase. `[REPO]`

## Suggested next slices (448+)

| Plan | Topic |
|------|-------|
| 417+ | Field-value arc merge stack **#81**–**#86** (open PR **#86**) |
| 448+ | Post-merge tracker sync after stack-simulation **#90**–**#116** lands |
| 448+ | Merge relay arc **#77**–**#88** then rebase stack-simulation tip |
| 448+ | Merge **#74** (CodeQL) early; KotorDiff installation ref search (**#71**) |
