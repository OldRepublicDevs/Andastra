...
- [ ] Affected projects compile cleanly. Prefer `dotnet build src/BioWare/BioWare.csproj --framework net9.0` for narrow checks; full solution may fail on OdyTools. `[REPO]` (`AGENTS.md`)
...
- Claiming "full solution builds" is false while OdyTools/OdyPatch are red — see [build-health-matrix.md](../40-operational-risk/build-health-matrix.md).
