...
Expected on `master` post [PR #58](https://github.com/th3w1zard1/Andastra/pull/58) (plan **368**): **92** NcsConsti + **18** FindStrRefCommand + **12** CLI ref-search + **10** StrRefReferenceHelper tests pass. Prior baseline post [PR #56](https://github.com/th3w1zard1/Andastra/pull/56) (plan **366**): **90** NcsConsti. `[REPO]`
