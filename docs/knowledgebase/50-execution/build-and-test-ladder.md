...
Expected on `master` post [PR #63](https://github.com/th3w1zard1/Andastra/pull/63) (plan **374**): **98** NcsConsti + **18** FindStrRefCommand + **12** CLI ref-search + **10** StrRefReferenceHelper tests pass. Open stack-simulation tip ([PR #133](https://github.com/th3w1zard1/Andastra/pull/133), plan **463**): **163** NcsConsti; prior intermediate ([PR #131](https://github.com/th3w1zard1/Andastra/pull/131), plan **461**): **161**. Full open-stack PR table and merge order: [pr-merge-readiness.md](../90-meta/pr-merge-readiness.md). Relay-only tip ([PR #88](https://github.com/th3w1zard1/Andastra/pull/88), plan **419**): **107** NcsConsti at `MaxNestedJsrRelayDepth = 6`. Prior baseline post [PR #61](https://github.com/th3w1zard1/Andastra/pull/61) (plan **372**): **96** NcsConsti. `[REPO]`
