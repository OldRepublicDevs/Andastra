...
Expected on `master` post [PR #48](https://github.com/th3w1zard1/Andastra/pull/48) / [PR #50](https://github.com/th3w1zard1/Andastra/pull/50): **83** NcsConsti + **18** FindStrRefCommand + **12** CLI ref-search + **10** StrRefReferenceHelper tests pass. After plan **362** / PR merge: **86** NcsConsti. `[REPO]`
