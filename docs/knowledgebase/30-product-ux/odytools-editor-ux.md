...
| StrRef find-refs NCS CONSTI cache path | Green — `StrRefReferenceCache` / `IncludeNcsStrRefScan` gating; **2** KotorCLI CLI tests at plan **286** baseline; superseded by **77** NcsConsti + **10** StrRefReferenceHelper rows (plans **324**–**356**) `[REPO]` |
...
| NCS CONSTI StrRef vs 2DA-memory threshold disambiguation | Green — threshold + opcode-context + action-signature + stack-store heuristics; **77** NcsConsti tests `[REPO]` (plans **086**/**095**/**099**/**292**–**294**/**303**/**305**/**307**/**324**–**356**, 2026-05-28) |
| NCS CONSTI control-flow reachability (JZ/JNZ/JMP fork, while-break, subroutine/infinite-loop) | Green — `NcsConstiScanner` forward scan + cache indexing; **77** NcsConsti tests `[REPO]` (plans **324**–**356**, 2026-05-24) |
