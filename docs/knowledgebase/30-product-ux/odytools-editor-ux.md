...
| NCS CONSTI StrRef vs 2DA-memory threshold disambiguation | Partial — `NcsConstiScanner.StrRefCandidateMinimum` (default **100**) excludes low CONSTI from cache indexing; slow-path StrRef queries still match; OdyTools options + KotorCLI `--ncs-strref-min`; **4** NcsConsti threshold/cache tests `[REPO]` (plans **086**/**095**/**099**, doc **292**) |
