...
namespace OdyTools.Tests
{
    ...
    /// </summary>
    public class OdyToolTwoDATests
    {
        ...
        private static ObservableCollection<ObservableCollection<string>> GetSourceData(OdyToolTwoDA editor)
        {
            var fi = typeof(OdyToolTwoDA).GetField("_sourceData", BindingFlags.NonPublic | BindingFlags.Instance);
            return (ObservableCollection<ObservableCollection<string>>)fi?.GetValue(editor);
        }

        private static DataGrid GetDataGrid(OdyToolTwoDA editor)
        {
            var fi = typeof(OdyToolTwoDA).GetField("_twodaTable", BindingFlags.NonPublic | BindingFlags.Instance);
            return fi?.GetValue(editor) as DataGrid;
        }

        private static List<string> GetColumnHeaders(OdyToolTwoDA editor)
        {
            var fi = typeof(OdyToolTwoDA).GetField("_columnHeaders", BindingFlags.NonPublic | BindingFlags.Instance);
            return fi?.GetValue(editor) as List<string>;
        }

        private static void SetSelection(OdyToolTwoDA editor, params int[] rowIndices)
        {
        ...
        private static void SetCurrentColumn(OdyToolTwoDA editor, int colIndex)
        {
            var grid = GetDataGrid(editor);
        ...
        private static void InvokeUndo(OdyToolTwoDA editor)
        {
            typeof(OdyToolTwoDA).GetMethod("Undo", BindingFlags.NonPublic | BindingFlags.Instance)?.Invoke(editor, null);
        }

        private static void InvokeRedo(OdyToolTwoDA editor)
        {
            typeof(OdyToolTwoDA).GetMethod("Redo", BindingFlags.NonPublic | BindingFlags.Instance)?.Invoke(editor, null);
        }

        private static void InvokeRevert(OdyToolTwoDA editor)
        {
            typeof(OdyToolTwoDA).GetMethod("Revert", BindingFlags.NonPublic | BindingFlags.Instance)?.Invoke(editor, null);
        }

        private static TwoDA BuildAndParse(OdyToolTwoDA editor)
        {
            var t = editor.Build();
        ...
        /// <summary>
        /// Creates a OdyToolTwoDA and shows it so the DataGrid visual tree is initialized.
        /// Required for headless tests that interact with DataGrid selection/columns.
        /// </summary>
        private static OdyToolTwoDA CreateEditor()
        {
            var editor = new OdyToolTwoDA(null, null);
            editor.Show();
            return editor;
        }

        private static string GetStatusText(OdyToolTwoDA editor)
        {
            var tb = editor.FindControl<Avalonia.Controls.TextBlock>("statusText");
            return tb?.Text ?? "";
        }

        private static string GetCellAddressText(OdyToolTwoDA editor)
        {
            var tb = editor.FindControl<Avalonia.Controls.TextBlock>("cellAddressText");
            return tb?.Text ?? "";
        }

        private static bool GetEmptyStateVisible(OdyToolTwoDA editor)
        {
            var overlay = editor.FindControl<Border>("emptyStateOverlay");
            return overlay != null && overlay.IsVisible;
        }

        private static string GetSidebarStatsText(OdyToolTwoDA editor)
        {
            var tb = editor.FindControl<Avalonia.Controls.TextBlock>("sidebarStatsText");
            return tb?.Text ?? "";
        }

        private static TextBox GetFilterEdit(OdyToolTwoDA editor)
        {
            return editor.FindControl<TextBox>("filterEdit");
        }

        [AvaloniaTest]
        public void OdyToolTwoDA_LoadAndBuild_PreservesData()
        {
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_LoadAndBuild_FullRoundtripFidelity()
        {
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_New_BuildsValidEmptyTwoDA()
        {
            var editor = CreateEditor();
            editor.New();
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_LoadCSVAndBuild_PreservesFormat()
        {
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_InsertRow_AppendsRowAndPreservesStructure()
        {
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_RemoveSelectedRows_DeletesAndShifts()
        {
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_DuplicateRow_ClonesAndAppends()
        {
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_DoFilter_ReducesVisibleRows()
        {
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_SortRows_AscendingAndDescending()
        {
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_FillDown_CopiesValueToSelectedRows()
        {
            byte[] data = CreateTestTwoDABytes(4);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_ClearCell_BlanksSelectedCells()
        {
            byte[] data = CreateTestTwoDABytes(3);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_InsertRowAbove_InsertsAtSelection()
        {
            byte[] data = CreateTestTwoDABytes(4);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_InsertRowBelow_InsertsAfterSelection()
        {
            byte[] data = CreateTestTwoDABytes(4);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_RedoRowLabels_RenumbersLabels()
        {
            byte[] data = CreateTestTwoDABytes(4);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_RemoveColumn_RemovesCurrentColumn()
        {
            byte[] data = CreateTestTwoDABytes(3);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public async Task OdyToolTwoDA_CopyAndPaste_RoundtripViaClipboard()
        {
            byte[] data = CreateTestTwoDABytes(3);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public async Task OdyToolTwoDA_PasteFromClipboard_InsertsData()
        {
            var editor = CreateEditor();
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_UndoRedo_RevertsAndReapplies()
        {
            byte[] data = CreateTestTwoDABytes(3);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_LoadInvalidData_HandlesGracefully()
        {
            var editor = CreateEditor();
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_LoadCorruptData_ResetsState()
        {
            var editor = CreateEditor();
            try
            {
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_SelectAllRows_SelectsAll()
        {
            byte[] data = CreateTestTwoDABytes(5);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public async Task OdyToolTwoDA_CutSelection_ClearsCellAndCopies()
        {
            byte[] data = CreateTestTwoDABytes(4);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_MultiRowRemove_DeletesAllSelected()
        {
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_SortNumeric_SortsByNumericValue()
        {
        ...
        [AvaloniaTest]
        public async Task OdyToolTwoDA_PasteTransposed_TransposesClipboard()
        {
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_Revert_RestoresOriginalData()
        {
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_EmptyLoad_NewState()
        {
            var editor = CreateEditor();
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_LoadAndBuild_FullRoundtripWithManyAssertions()
        {
        ...
        [AvaloniaTest]
        public async Task OdyToolTwoDA_CopySelection_EmptySelectionDoesNothing()
        {
            byte[] data = CreateTestTwoDABytes(3);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public async Task OdyToolTwoDA_CopyThenPaste_FullRowRoundtrip()
        {
            byte[] data = CreateTestTwoDABytes(4);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public async Task OdyToolTwoDA_PasteCSV_InterpretsCommas()
        {
            var editor = CreateEditor();
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_DoFilter_ThenClear_RestoresAllRows()
        {
            byte[] data = CreateTestTwoDABytes(10);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_UndoRedo_ChainOfOperations()
        {
            byte[] data = CreateTestTwoDABytes(3);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_ClearCell_ThenUndo_RestoresValue()
        {
            byte[] data = CreateTestTwoDABytes(3);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_FillDown_SingleRow_NoChange()
        {
            byte[] data = CreateTestTwoDABytes(2);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_DuplicateRow_ThenMutate_Independent()
        {
            byte[] data = CreateTestTwoDABytes(3);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_InsertRowAbove_AtFirstRow()
        {
            byte[] data = CreateTestTwoDABytes(3);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_InsertRowBelow_AtLastRow()
        {
            byte[] data = CreateTestTwoDABytes(3);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_RedoRowLabels_AfterManualEdits()
        {
            byte[] data = CreateTestTwoDABytes(4);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_New_InitialState()
        {
            var editor = CreateEditor();
            editor.New();
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_LoadInvalidData_MultipleAssertions()
        {
            var editor = CreateEditor();
            editor.Load("bad.2da", "bad", ResourceType.TwoDA, new byte[0]);
        ...
        [AvaloniaTest]
        public async Task OdyToolTwoDA_SelectAllRows_ThenCopy_FullTable()
        {
            byte[] data = CreateTestTwoDABytes(5);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public async Task OdyToolTwoDA_CutThenPaste_RestoresAtNewPosition()
        {
            byte[] data = CreateTestTwoDABytes(5);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public async Task OdyToolTwoDA_PasteTransposed_StructureVerification()
        {
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_Revert_AfterMultipleEdits()
        {
            byte[] original = CreateTestTwoDABytes(4);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, original);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_Sort_ThenUndo_RestoresOrder()
        {
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_RemoveColumn_LastColumn_RemovesCorrectly()
        {
            byte[] data = CreateTestTwoDABytes(3);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_LoadNull_NewState()
        {
            var editor = CreateEditor();
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_ToggleFilter_DoesNotThrow()
        {
            byte[] data = CreateTestTwoDABytes(3);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_DoubleClickColumnHeader_AllowsEditing()
        {
            var editor = CreateEditor();
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_DoubleClickAddColumnZone_AddsColumn()
        {
            var editor = CreateEditor();
            editor.New();
            var headersBefore = GetColumnHeaders(editor);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_LoadsFullXamlUi_NotProgrammaticFallback()
        {
            var editor = CreateEditor();
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_MoveSelectedRowsUpDown_ReordersRows()
        {
            byte[] data = CreateTestTwoDABytes(4);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_MoveCurrentColumnLeftRight_ReordersHeaderAndData()
        {
            byte[] data = CreateTestTwoDABytes(3);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_ToggleSidebar_HidesAndShowsSidebar()
        {
            var editor = CreateEditor();
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_StatusBar_AfterLoad_ShowsRowAndColumnCount()
        {
            byte[] data = CreateTestTwoDABytes(5);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_StatusBar_AfterNew_ShowsOneRowOneColumn()
        {
            var editor = CreateEditor();
            editor.New();
            string status = GetStatusText(editor);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_StatusBar_WhenMultipleRowsSelected_ShowsSelectedCount()
        {
            byte[] data = CreateTestTwoDABytes(5);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_StatusBar_WhenFilterActive_ShowsVisibleCount()
        {
            byte[] data = CreateTestTwoDABytes(10);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_StatusBar_WhenSidebarHidden_ShowsSidebarHidden()
        {
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, CreateTestTwoDABytes(2));
            editor.ToggleSidebar();
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_StatusBar_WhenCellSelected_ShowsCellReference()
        {
            byte[] data = CreateTestTwoDABytes(3);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_EmptyState_WhenZeroRows_IsVisible()
        {
            var editor = CreateEditor();
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_EmptyState_AfterNew_IsNotVisible()
        {
            var editor = CreateEditor();
            editor.New();
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_EmptyState_AfterLoadWithData_IsNotVisible()
        {
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, CreateTestTwoDABytes(1));
            Assert.That(GetEmptyStateVisible(editor), Is.False);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_FormulaBar_WhenNoSelection_ShowsDashOrEmpty()
        {
            var editor = CreateEditor();
            editor.New();
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_FormulaBar_WhenCellSelected_Updates()
        {
            byte[] data = CreateTestTwoDABytes(3);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_SetVerticalHeaderOption_DoesNotBreakBuild()
        {
            byte[] data = CreateTestTwoDABytes(2);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_AddColumnQuick_GreenButtonEquivalent_AddsColumn()
        {
            var editor = CreateEditor();
            editor.New();
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_FilterEdit_ClearButton_ResetsFilter()
        {
            byte[] data = CreateTestTwoDABytes(10);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_SelectCurrentColumn_ThenFillDown_FillsColumn()
        {
            byte[] data = CreateTestTwoDABytes(4);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_RemoveSelectedRows_WhenNoSelection_NoThrow()
        {
            byte[] data = CreateTestTwoDABytes(3);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_DuplicateRow_WhenNoSelection_NoThrow()
        {
            byte[] data = CreateTestTwoDABytes(3);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_InsertRow_WhenNoSelection_Appends()
        {
            byte[] data = CreateTestTwoDABytes(2);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_New_ThenAddColumnQuickTwice_ThenInsertRow_BuildsValid()
        {
            var editor = CreateEditor();
            editor.New();
            editor.AddColumnQuick();
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_Revert_UpdatesStatusAndBuild()
        {
            byte[] original = CreateTestTwoDABytes(4);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, original);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_Undo_MultipleLevels_ThenRedoAll()
        {
            byte[] data = CreateTestTwoDABytes(2);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_Paste_WhenEmptyTable_UsesFirstLineAsHeaders()
        {
            var editor = CreateEditor();
            editor.Load("empty.2da", "empty", ResourceType.TwoDA, new byte[0]);
            Assert.That(GetSourceData(editor).Count, Is.EqualTo(0));
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_MoveRowUp_ThenMoveRowDown_RestoresOrder()
        {
            byte[] data = CreateTestTwoDABytes(4);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_RemoveColumn_ThenBuild_HeadersAndDataConsistent()
        {
            byte[] data = CreateTestTwoDABytes(3);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_ToggleFilter_ShowsOrHidesFilterSection()
        {
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, CreateTestTwoDABytes(2));
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_Load_SetsWindowTitle()
        {
            var editor = CreateEditor();
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_Build_AfterEveryAction_ProducesValidTwoDA()
        {
            byte[] data = CreateTestTwoDABytes(3);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_AllSidebarButtons_InvokeSameActionsAsMenu()
        {
            byte[] data = CreateTestTwoDABytes(3);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_SortAsc_ThenSortDesc_RestoresVisualOrder()
        {
            var twoDA = new TwoDA(new List<string> { "label", "x" });
            twoDA.AddRow("0", new Dictionary<string, object> { ["label"] = "0", ["x"] = "C" });
            twoDA.AddRow("1", new Dictionary<string, object> { ["label"] = "1", ["x"] = "A" });
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_LoadCSV_BuildPreservesContent()
        {
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_EmptyStateText_WhenVisible_ContainsHelpfulMessage()
        {
            var editor = CreateEditor();
            editor.Load("empty.2da", "empty", ResourceType.TwoDA, new byte[0]);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_DataGrid_ExistsAndHasColumnsAfterLoad()
        {
            byte[] data = CreateTestTwoDABytes(2);
            var editor = CreateEditor();
            editor.Load("test.2da", "test", ResourceType.TwoDA, data);
        ...
        [AvaloniaTest]
        public void OdyToolTwoDA_FormulaBarEdit_ExistsInXaml()
        {
            var editor = CreateEditor();
