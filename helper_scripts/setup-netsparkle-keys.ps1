...
Write-Host "   Update src/OdyPatch/UpdateManager.cs:" -ForegroundColor White
...
Write-Host "   - Go to: https://github.com/th3w1zard1/OdyPatch/settings/secrets/actions" -ForegroundColor White
