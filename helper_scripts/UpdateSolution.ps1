...
$projects = @(
    ...
    @{ Name = "OdyPatch"; Path = "src\Tools\OdyPatch\OdyPatch.csproj"; Guid = "FE5139A3-4BEF-48A9-A23E-4A045318830B" },
    @{ Name = "OdyPatch.UI"; Path = "src\Tools\OdyPatch.UI\OdyPatch.UI.csproj"; Guid = "47B7732C-EA7D-446C-8309-C86FBDD871CB" },
    @{ Name = "OdyTools"; Path = "src\Tools\OdyTools\OdyTools.csproj"; Guid = "0538F16A-7412-4766-88F1-7B533E68FAAD" },
    ...
    @{ Name = "OdyTools.Tests"; Path = "tests\OdyTools.Tests\OdyTools.Tests.csproj"; Guid = "6025114D-89C8-453E-8BAA-B5D0DD1D49C3" },
