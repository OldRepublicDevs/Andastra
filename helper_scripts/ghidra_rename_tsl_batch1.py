...
except Exception as e: print('ERR 0x40E4D0: '+str(e)); errors += 1
try:
...
except Exception as e: print('ERR 0x42A670: '+str(e)); errors += 1
try:
...
except Exception as e: print('ERR 0x458AD0: '+str(e)); errors += 1
try:
...
except Exception as e: print('ERR 0x475A80: '+str(e)); errors += 1
try:
...
except Exception as e: print('ERR 0x5072C0: '+str(e)); errors += 1
try:
...
except Exception as e: print('ERR 0x54D3C0: '+str(e)); errors += 1
try:
...
except Exception as e: print('ERR 0x5EBDC0: '+str(e)); errors += 1
try:
...
except Exception as e: print('ERR 0x64BF60: '+str(e)); errors += 1
try:
...
except Exception as e: print('ERR 0x775D20: '+str(e)); errors += 1
try:
...
except Exception as e: print('ERR 0x775F40: '+str(e)); errors += 1
try:
...
except Exception as e: print('ERR 0x776060: '+str(e)); errors += 1
try:
...
except Exception as e: print('ERR 0x475B50: '+str(e)); errors += 1
